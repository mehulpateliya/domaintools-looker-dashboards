...
datagroup: test_domain_tool_default_datagroup {
  # sql_trigger: SELECT MAX(id) FROM etl_log;;
  max_cache_age: "1 hour"
}

persist_with: test_domain_tool_default_datagroup
...
explore: entity_graph {
    ...
    join: entity_graph__metadata__threat__verdict_info {
      view_label: "Entity Graph: Metadata Threat Verdict Info"
      sql: LEFT JOIN UNNEST(${entity_graph__metadata__threat.verdict_info}) as entity_graph__metadata__threat__verdict_info ;;
      relationship: one_to_many
    }
    ...
    join: entity_graph__entity__security_result__verdict_info {
      view_label: "Entity Graph: Entity Security Result Verdict Info"
      sql: LEFT JOIN UNNEST(${entity_graph__entity__security_result.verdict_info}) as entity_graph__entity__security_result__verdict_info ;;
      relationship: one_to_many
    }
    ...
    join: entity_graph__metadata__threat__verdict_info__ioc_stats {
      view_label: "Entity Graph: Metadata Threat Verdict Info Ioc Stats"
      sql: LEFT JOIN UNNEST(${entity_graph__metadata__threat__verdict_info.ioc_stats}) as entity_graph__metadata__threat__verdict_info__ioc_stats ;;
      relationship: one_to_many
    }
    ...
    join: entity_graph__relations__entity__security_result__verdict_info {
      view_label: "Entity Graph: Relations Entity Security Result Verdict Info"
      sql: LEFT JOIN UNNEST(${entity_graph__relations__entity__security_result.verdict_info}) as entity_graph__relations__entity__security_result__verdict_info ;;
      relationship: one_to_many
    }
    ...
    join: entity_graph__entity__security_result__verdict_info__ioc_stats {
      view_label: "Entity Graph: Entity Security Result Verdict Info Ioc Stats"
      sql: LEFT JOIN UNNEST(${entity_graph__entity__security_result__verdict_info.ioc_stats}) as entity_graph__entity__security_result__verdict_info__ioc_stats ;;
      relationship: one_to_many
    }
    ...
    join: entity_graph__relations__entity__security_result__verdict_info__ioc_stats {
      view_label: "Entity Graph: Relations Entity Security Result Verdict Info Ioc Stats"
      sql: LEFT JOIN UNNEST(${entity_graph__relations__entity__security_result__verdict_info.ioc_stats}) as entity_graph__relations__entity__security_result__verdict_info__ioc_stats ;;
      relationship: one_to_many
    }
...
explore: events {
  ...
  join: latest__events {
      view_label: "Events: latest "
      type: left_outer
      sql_on: ${latest__events.events_metadata__id} = ${events.metadata__id} ;;
      relationship: one_to_many

    }
    join: latest__events_test {
      view_label: "Events: latest new"
      type: left_outer
      sql_on: ${latest__events_test.events_metadata__id} = ${events.metadata__id}  ;;
      relationship: one_to_many

    }
    join: entity_graph {
      view_label: "Join entity"
      type: left_outer
      sql_on: ${entity_graph.metadata__event_metadata__id} = ${events.metadata__id}  ;;
