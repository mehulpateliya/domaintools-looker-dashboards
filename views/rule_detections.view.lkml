...
view: rule_detections {
  ...
  dimension: detection__alert_type {
    type: number
  ...
  dimension: detection__commit_timestamp__seconds {
    type: number
  ...
  dimension: detection__events__src__ip {
    hidden: yes
    sql: ${TABLE}.detection.events.src.ip ;;
    group_label: "Detection Events Src"
    group_item_label: "IP"
  }
  dimension: detection__events__src__mac {
    hidden: yes
    sql: ${TABLE}.detection.events.src.mac ;;
    group_label: "Detection Events Src"
    group_item_label: "Mac"
  }
  dimension: detection__fields {
    hidden: yes
    sql: ${TABLE}.detection.fields ;;
    group_label: "Detection"
    group_item_label: "Fields"
  }
  measure: max_version_timestamp {
    type: max
  ...
  dimension: detection__time_window__end_time__nanos {
    type: number
    sql: ${TABLE}.detection.time_window.end_time.nanos ;;
    group_label: "Detection Time Window End Time"
    group_item_label: "Nanos"
  }
  dimension: detection__time_window__end_time__seconds {
    type: number
    sql: ${TABLE}.detection.time_window.end_time.seconds ;;
    group_label: "Detection Time Window End Time"
    group_item_label: "Seconds"
  }
  dimension: detection__time_window__start_time__nanos {
    type: number
    sql: ${TABLE}.detection.time_window.start_time.nanos ;;
    group_label: "Detection Time Window Start Time"
    group_item_label: "Nanos"
  }
  dimension: detection__time_window__start_time__seconds {
    type: number
    sql: ${TABLE}.detection.time_window.start_time.seconds ;;
    group_label: "Detection Time Window Start Time"
    group_item_label: "Seconds"
  }
  dimension: detection__users {
    hidden: yes
    sql: ${TABLE}.detection.users ;;
    group_label: "Detection"
  ...
  dimension: version_timestamp__nanos {
    ...
    group_label: "Version Timestamp"
    group_item_label: "Nanos"
  }
  dimension: version_timestamp__seconds {
    type: number
    sql: ${TABLE}.version_timestamp.seconds ;;
    group_label: "Version Timestamp"
    group_item_label: "Seconds"
  }
  measure: count {
...
view: rule_detections__rulesets {
  ...
  dimension: rule_detections__rulesets {
    type: string
    hidden: yes
    sql: rule_detections__rulesets ;;
  }
  dimension: ruleset_family_name {
    type: string
    sql: ruleset_family_name ;;
  }
...
view: rule_detections__detection__assets {
  ...
  dimension: is_any_namespace {
    type: yesno
    sql: ${TABLE}.is_any_namespace ;;
  }
  dimension: is_namespace_ignored {
    type: yesno
    sql: ${TABLE}.is_namespace_ignored ;;
  }
  dimension: mac {
    type: string
    sql: ${TABLE}.mac ;;
...
view: rule_detections__detection__events__src__ip {

  dimension: rule_detections__detection__events__src__ip {
    type: string
    sql: rule_detections__detection__events__src__ip ;;
  }
}

view: rule_detections__detection__events__src__mac {

  dimension: rule_detections__detection__events__src__mac {
    type: string
    sql: rule_detections__detection__events__src__mac ;;
  }
}

view: rule_detections__detection__events {
...
view: rule_detections__detection__events__about__ip {

  dimension: rule_detections__detection__events__about__ip {
    type: string
    sql: rule_detections__detection__events__about__ip ;;
  }
}

view: rule_detections__detection__events__about__mac {

  dimension: rule_detections__detection__events__about__mac {
    type: string
    sql: rule_detections__detection__events__about__mac ;;
  }
}
...
view: rule_detections__detection__events__target__ip {

  dimension: rule_detections__detection__events__target__ip {
    type: string
    sql: rule_detections__detection__events__target__ip ;;
  }
}

view: rule_detections__detection__events__src__nat_ip {

  dimension: rule_detections__detection__events__src__nat_ip {
    type: string
    sql: rule_detections__detection__events__src__nat_ip ;;
  }
}

view: rule_detections__detection__events__target__mac {

  dimension: rule_detections__detection__events__target__mac {
    type: string
    sql: rule_detections__detection__events__target__mac ;;
  }
}

view: rule_detections__detection__events__observer__ip {

  dimension: rule_detections__detection__events__observer__ip {
    type: string
    sql: rule_detections__detection__events__observer__ip ;;
  }
}

view: rule_detections__detection__events__principal__ip {

  dimension: rule_detections__detection__events__principal__ip {
    type: string
    sql: rule_detections__detection__events__principal__ip ;;
  }
}

view: rule_detections__detection__events__observer__mac {

  dimension: rule_detections__detection__events__observer__mac {
    type: string
    sql: rule_detections__detection__events__observer__mac ;;
  }
}

view: rule_detections__detection__events__src__asset__ip {

  dimension: rule_detections__detection__events__src__asset__ip {
    type: string
    sql: rule_detections__detection__events__src__asset__ip ;;
  }
}

view: rule_detections__detection__events__about__nat_ip {

  dimension: rule_detections__detection__events__about__nat_ip {
    type: string
    sql: rule_detections__detection__events__about__nat_ip ;;
  }
}

view: rule_detections__detection__events__principal__mac {

  dimension: rule_detections__detection__events__principal__mac {
    type: string
    sql: rule_detections__detection__events__principal__mac ;;
  }
}

view: rule_detections__detection__events__src__asset__mac {

  dimension: rule_detections__detection__events__src__asset__mac {
    type: string
    sql: rule_detections__detection__events__src__asset__mac ;;
  }
}

view: rule_detections__detection__events__target__nat_ip {

  dimension: rule_detections__detection__events__target__nat_ip {
    type: string
    sql: rule_detections__detection__events__target__nat_ip ;;
  }
}

view: rule_detections__detection__events__src__labels {
...
view: rule_detections__detection__events__about__asset__ip {

  dimension: rule_detections__detection__events__about__asset__ip {
    type: string
    sql: rule_detections__detection__events__about__asset__ip ;;
  }
}

view: rule_detections__detection__events__observer__nat_ip {

  dimension: rule_detections__detection__events__observer__nat_ip {
    type: string
    sql: rule_detections__detection__events__observer__nat_ip ;;
  }
}

view: rule_detections__detection__events__about__asset__mac {

  dimension: rule_detections__detection__events__about__asset__mac {
    type: string
    sql: rule_detections__detection__events__about__asset__mac ;;
  }
}

view: rule_detections__detection__events__intermediary__ip {

  dimension: rule_detections__detection__events__intermediary__ip {
    type: string
    sql: rule_detections__detection__events__intermediary__ip ;;
  }
}

view: rule_detections__detection__events__target__asset__ip {

  dimension: rule_detections__detection__events__target__asset__ip {
    type: string
    sql: rule_detections__detection__events__target__asset__ip ;;
  }
}

view: rule_detections__detection__events__principal__nat_ip {

  dimension: rule_detections__detection__events__principal__nat_ip {
    type: string
    sql: rule_detections__detection__events__principal__nat_ip ;;
  }
}

view: rule_detections__detection__events__about__labels {
...
view: rule_detections__detection__events__intermediary__mac {

  dimension: rule_detections__detection__events__intermediary__mac {
    type: string
    sql: rule_detections__detection__events__intermediary__mac ;;
  }
}
...
view: rule_detections__detection__events__target__asset__mac {

  dimension: rule_detections__detection__events__target__asset__mac {
    type: string
    sql: rule_detections__detection__events__target__asset__mac ;;
  }
}

view: rule_detections__detection__events__network__email__cc {

  dimension: rule_detections__detection__events__network__email__cc {
    type: string
    sql: rule_detections__detection__events__network__email__cc ;;
  }
}

view: rule_detections__detection__events__observer__asset__ip {

  dimension: rule_detections__detection__events__observer__asset__ip {
    type: string
    sql: rule_detections__detection__events__observer__asset__ip ;;
  }
}

view: rule_detections__detection__events__target__labels {
...
view: rule_detections__detection__events__network__email__bcc {

  dimension: rule_detections__detection__events__network__email__bcc {
    type: string
    sql: rule_detections__detection__events__network__email__bcc ;;
  }
}
...
view: rule_detections__detection__events__principal__asset__ip {
  ...
  dimension: rule_detections__detection__events__principal__asset__ip {
    type: string
    sql: rule_detections__detection__events__principal__asset__ip ;;
  }
}

view: rule_detections__detection__events__observer__asset__mac {

  dimension: rule_detections__detection__events__observer__asset__mac {
    type: string
    sql: rule_detections__detection__events__observer__asset__mac ;;
  }
}

view: rule_detections__detection__events__network__email__to {

  dimension: rule_detections__detection__events__network__email__to {
    type: string
    sql: rule_detections__detection__events__network__email__to ;;
  }
}

view: rule_detections__detection__events__principal__asset__mac {

  dimension: rule_detections__detection__events__principal__asset__mac {
    type: string
    sql: rule_detections__detection__events__principal__asset__mac ;;
  }
}

view: rule_detections__detection__events__observer__labels {
...
view: rule_detections__detection__events__src__user__department {

  dimension: rule_detections__detection__events__src__user__department {
    type: string
    sql: rule_detections__detection__events__src__user__department ;;
  }
}

view: rule_detections__detection__events__intermediary__nat_ip {

  dimension: rule_detections__detection__events__intermediary__nat_ip {
    type: string
    sql: rule_detections__detection__events__intermediary__nat_ip ;;
  }
}
...
view: rule_detections__detection__events__src__asset__labels {
...
view: rule_detections__detection__events__additional__fields {
...
view: rule_detections__detection__events__about__user__department {

  dimension: rule_detections__detection__events__about__user__department {
    type: string
    sql: rule_detections__detection__events__about__user__department ;;
  }
}

view: rule_detections__detection__events__intermediary__asset__ip {

  dimension: rule_detections__detection__events__intermediary__asset__ip {
    type: string
    sql: rule_detections__detection__events__intermediary__asset__ip ;;
  }
}

view: rule_detections__detection__events__network__email__subject {
...
view: rule_detections__detection__events__src__asset__hardware {
...
view: rule_detections__detection__events__src__user__phone_numbers {

  dimension: rule_detections__detection__events__src__user__phone_numbers {
    type: string
    sql: rule_detections__detection__events__src__user__phone_numbers ;;
  }
}

view: rule_detections__detection__events__about__asset__labels {
...
view: rule_detections__detection__events__intermediary__asset__mac {

  dimension: rule_detections__detection__events__intermediary__asset__mac {
    type: string
    sql: rule_detections__detection__events__intermediary__asset__mac ;;
  }
}

view: rule_detections__detection__events__security_result__action {

  dimension: rule_detections__detection__events__security_result__action {
    type: number
    sql: rule_detections__detection__events__security_result__action ;;
  }
}

view: rule_detections__detection__events__target__user__department {
...
view: rule_detections__detection__events__src__asset__software {
...
view: rule_detections__detection__events__intermediary__labels {
...
view: rule_detections__detection__events__security_result {
...
view: rule_detections__detection__events__target__asset__labels {
...
view: rule_detections__detection__events__network__dns__answers {
...
view: rule_detections__detection__events__observer__user__department {
  ...
  dimension: rule_detections__detection__events__observer__user__department {
    type: string
    sql: rule_detections__detection__events__observer__user__department ;;
  }
}

view: rule_detections__detection__events__src__user__email_addresses {

  dimension: rule_detections__detection__events__src__user__email_addresses {
    type: string
    sql: rule_detections__detection__events__src__user__email_addresses ;;
  }
}

view: rule_detections__detection__events__about__asset__hardware {
...
view: rule_detections__detection__events__about__user__phone_numbers {

  dimension: rule_detections__detection__events__about__user__phone_numbers {
    type: string
    sql: rule_detections__detection__events__about__user__phone_numbers ;;
  }
}

view: rule_detections__detection__events__security_result__about__ip {

  dimension: rule_detections__detection__events__security_result__about__ip {
    type: string
    sql: rule_detections__detection__events__security_result__about__ip ;;
  }
}

view: rule_detections__detection__events__security_result__category {
...
view: rule_detections__detection__events__principal__user__department {

  dimension: rule_detections__detection__events__principal__user__department {
    type: string
    sql: rule_detections__detection__events__principal__user__department ;;
  }
}

view: rule_detections__detection__events__observer__asset__labels {
...
view: rule_detections__detection__events__extensions__auth__mechanism {

  dimension: rule_detections__detection__events__extensions__auth__mechanism {
    type: number
    sql: rule_detections__detection__events__extensions__auth__mechanism ;;
  }
}

view: rule_detections__detection__events__src__process_ancestors {
...
view: rule_detections__detection__events__about__asset__software {
...
view: rule_detections__detection__events__security_result__about__mac {

  dimension: rule_detections__detection__events__security_result__about__mac {
    type: string
    sql: rule_detections__detection__events__security_result__about__mac ;;
  }
}

view: rule_detections__detection__events__target__asset__hardware {
...
view: rule_detections__detection__events__target__user__phone_numbers {

  dimension: rule_detections__detection__events__target__user__phone_numbers {
    type: string
    sql: rule_detections__detection__events__target__user__phone_numbers ;;
  }
}

view: rule_detections__detection__events__network__dns__authority {
...
view: rule_detections__detection__events__network__dhcp__options {
...
view: rule_detections__detection__events__principal__asset__labels {
...
view: rule_detections__detection__events__src__investigation__comments {

  dimension: rule_detections__detection__events__src__investigation__comments {
    type: string
    sql: rule_detections__detection__events__src__investigation__comments ;;
  }
}

view: rule_detections__detection__events__src__user__group_identifiers {

  dimension: rule_detections__detection__events__src__user__group_identifiers {
    type: string
    sql: rule_detections__detection__events__src__user__group_identifiers ;;
  }
}

view: rule_detections__detection__events__about__user__email_addresses {

  dimension: rule_detections__detection__events__about__user__email_addresses {
    type: string
    sql: rule_detections__detection__events__about__user__email_addresses ;;
  }
}

view: rule_detections__detection__events__target__asset__software {
...
view: rule_detections__detection__events__network__dns__additional {
...
view: rule_detections__detection__events__network__dns__questions {
...
view: rule_detections__detection__events__observer__asset__hardware {
...
view: rule_detections__detection__events__observer__user__phone_numbers {

  dimension: rule_detections__detection__events__observer__user__phone_numbers {
    type: string
    sql: rule_detections__detection__events__observer__user__phone_numbers ;;
  }
}

view: rule_detections__detection__events__src__group__email_addresses {

  dimension: rule_detections__detection__events__src__group__email_addresses {
    type: string
    sql: rule_detections__detection__events__src__group__email_addresses ;;
  }
}

view: rule_detections__detection__events__about__process_ancestors {
...
view: rule_detections__detection__events__target__user__email_addresses {

  dimension: rule_detections__detection__events__target__user__email_addresses {
    type: string
    sql: rule_detections__detection__events__target__user__email_addresses ;;
  }
}

view: rule_detections__detection__events__principal__asset__hardware {
...
view: rule_detections__detection__events__principal__user__phone_numbers {

  dimension: rule_detections__detection__events__principal__user__phone_numbers {
    type: string
    sql: rule_detections__detection__events__principal__user__phone_numbers ;;
  }
}

view: rule_detections__detection__events__observer__asset__software {
...
view: rule_detections__detection__events__about__investigation__comments {

  dimension: rule_detections__detection__events__about__investigation__comments {
    type: string
    sql: rule_detections__detection__events__about__investigation__comments ;;
  }
}

view: rule_detections__detection__events__about__user__group_identifiers {

  dimension: rule_detections__detection__events__about__user__group_identifiers {
    type: string
    sql: rule_detections__detection__events__about__user__group_identifiers ;;
  }
}

view: rule_detections__detection__events__intermediary__user__department {

  dimension: rule_detections__detection__events__intermediary__user__department {
    type: string
    sql: rule_detections__detection__events__intermediary__user__department ;;
  }
}

view: rule_detections__detection__events__security_result__about__nat_ip {

  dimension: rule_detections__detection__events__security_result__about__nat_ip {
    type: string
    sql: rule_detections__detection__events__security_result__about__nat_ip ;;
  }
}

view: rule_detections__detection__events__target__process_ancestors {
...
view: rule_detections__detection__events__principal__asset__software {
...
view: rule_detections__detection__events__observer__user__email_addresses {

  dimension: rule_detections__detection__events__observer__user__email_addresses {
    type: string
    sql: rule_detections__detection__events__observer__user__email_addresses ;;
  }
}

view: rule_detections__detection__events__metadata__ingestion_labels {
...
view: rule_detections__detection__events__src__user__attribute__labels {
...
view: rule_detections__detection__events__about__group__email_addresses {

  dimension: rule_detections__detection__events__about__group__email_addresses {
    type: string
    sql: rule_detections__detection__events__about__group__email_addresses ;;
  }
}

view: rule_detections__detection__events__intermediary__asset__labels {
...
view: rule_detections__detection__events__target__investigation__comments {

  dimension: rule_detections__detection__events__target__investigation__comments {
    type: string
    sql: rule_detections__detection__events__target__investigation__comments ;;
  }
}

view: rule_detections__detection__events__target__user__group_identifiers {

  dimension: rule_detections__detection__events__target__user__group_identifiers {
    type: string
    sql: rule_detections__detection__events__target__user__group_identifiers ;;
  }
}

view: rule_detections__detection__events__principal__user__email_addresses {

  dimension: rule_detections__detection__events__principal__user__email_addresses {
    type: string
    sql: rule_detections__detection__events__principal__user__email_addresses ;;
  }
}

view: rule_detections__detection__events__observer__process_ancestors {
...
view: rule_detections__detection__events__src__asset__attribute__labels {
...
view: rule_detections__detection__events__security_result__about__asset__ip {

  dimension: rule_detections__detection__events__security_result__about__asset__ip {
    type: string
    sql: rule_detections__detection__events__security_result__about__asset__ip ;;
  }
}

view: rule_detections__detection__events__target__group__email_addresses {

  dimension: rule_detections__detection__events__target__group__email_addresses {
    type: string
    sql: rule_detections__detection__events__target__group__email_addresses ;;
  }
}

view: rule_detections__detection__events__principal__process_ancestors {
...
view: rule_detections__detection__events__observer__investigation__comments {

  dimension: rule_detections__detection__events__observer__investigation__comments {
    type: string
    sql: rule_detections__detection__events__observer__investigation__comments ;;
  }
}

view: rule_detections__detection__events__observer__user__group_identifiers {

  dimension: rule_detections__detection__events__observer__user__group_identifiers {
    type: string
    sql: rule_detections__detection__events__observer__user__group_identifiers ;;
  }
}

view: rule_detections__detection__events__src__user_management_chain {
...
view: rule_detections__detection__events__about__user__attribute__labels {
...
view: rule_detections__detection__events__intermediary__asset__hardware {
...
view: rule_detections__detection__events__intermediary__user__phone_numbers {

  dimension: rule_detections__detection__events__intermediary__user__phone_numbers {
    type: string
    sql: rule_detections__detection__events__intermediary__user__phone_numbers ;;
  }
}

view: rule_detections__detection__events__security_result__about__asset__mac {

  dimension: rule_detections__detection__events__security_result__about__asset__mac {
    type: string
    sql: rule_detections__detection__events__security_result__about__asset__mac ;;
  }
}

view: rule_detections__detection__events__principal__investigation__comments {

  dimension: rule_detections__detection__events__principal__investigation__comments {
    type: string
    sql: rule_detections__detection__events__principal__investigation__comments ;;
  }
}

view: rule_detections__detection__events__principal__user__group_identifiers {

  dimension: rule_detections__detection__events__principal__user__group_identifiers {
    type: string
    sql: rule_detections__detection__events__principal__user__group_identifiers ;;
  }
}

view: rule_detections__detection__events__observer__group__email_addresses {

  dimension: rule_detections__detection__events__observer__group__email_addresses {
    type: string
    sql: rule_detections__detection__events__observer__group__email_addresses ;;
  }
}

view: rule_detections__detection__events__src__group__attribute__labels {
...
view: rule_detections__detection__events__about__asset__attribute__labels {
...
view: rule_detections__detection__events__intermediary__asset__software {
...
view: rule_detections__detection__events__security_result__about__labels {
...
view: rule_detections__detection__events__security_result__category_details {

  dimension: rule_detections__detection__events__security_result__category_details {
    type: string
    sql: rule_detections__detection__events__security_result__category_details ;;
  }
}

view: rule_detections__detection__events__target__user__attribute__labels {
...
view: rule_detections__detection__events__principal__group__email_addresses {

  dimension: rule_detections__detection__events__principal__group__email_addresses {
    type: string
    sql: rule_detections__detection__events__principal__group__email_addresses ;;
  }
}

view: rule_detections__detection__events__src__resource__attribute__labels {
...
view: rule_detections__detection__events__about__user_management_chain {
...
view: rule_detections__detection__events__intermediary__user__email_addresses {

  dimension: rule_detections__detection__events__intermediary__user__email_addresses {
    type: string
    sql: rule_detections__detection__events__intermediary__user__email_addresses ;;
  }
}

view: rule_detections__detection__events__target__asset__attribute__labels {
...
view: rule_detections__detection__events__observer__user__attribute__labels {
...
view: rule_detections__detection__events__src__cloud__vpc__attribute__labels {
...
view: rule_detections__detection__events__about__group__attribute__labels {
...
view: rule_detections__detection__events__intermediary__process_ancestors {
...
view: rule_detections__detection__events__target__user_management_chain {
...
view: rule_detections__detection__events__principal__user__attribute__labels {
...
view: rule_detections__detection__events__observer__asset__attribute__labels {
...
view: rule_detections__detection__events__about__resource__attribute__labels {
...
view: rule_detections__detection__events__intermediary__investigation__comments {

  dimension: rule_detections__detection__events__intermediary__investigation__comments {
    type: string
    sql: rule_detections__detection__events__intermediary__investigation__comments ;;
  }
}

view: rule_detections__detection__events__intermediary__user__group_identifiers {

  dimension: rule_detections__detection__events__intermediary__user__group_identifiers {
    type: string
    sql: rule_detections__detection__events__intermediary__user__group_identifiers ;;
  }
}

view: rule_detections__detection__events__target__group__attribute__labels {
...
view: rule_detections__detection__events__principal__asset__attribute__labels {
...
view: rule_detections__detection__events__observer__user_management_chain {
...
view: rule_detections__detection__events__src__user_management_chain__department {

  dimension: rule_detections__detection__events__src__user_management_chain__department {
    type: string
    sql: rule_detections__detection__events__src__user_management_chain__department ;;
  }
}

view: rule_detections__detection__events__about__cloud__vpc__attribute__labels {
...
view: rule_detections__detection__events__intermediary__group__email_addresses {

  dimension: rule_detections__detection__events__intermediary__group__email_addresses {
    type: string
    sql: rule_detections__detection__events__intermediary__group__email_addresses ;;
  }
}

view: rule_detections__detection__events__security_result__detection_fields {
...
view: rule_detections__detection__events__target__resource__attribute__labels {
...
view: rule_detections__detection__events__network__tls__client__supported_ciphers {

  dimension: rule_detections__detection__events__network__tls__client__supported_ciphers {
    type: string
    sql: rule_detections__detection__events__network__tls__client__supported_ciphers ;;
  }
}

view: rule_detections__detection__events__principal__user_management_chain {
...
view: rule_detections__detection__events__observer__group__attribute__labels {
...
view: rule_detections__detection__events__extensions__vulns__vulnerabilities {
...
view: rule_detections__detection__events__security_result__about__user__department {

  dimension: rule_detections__detection__events__security_result__about__user__department {
    type: string
    sql: rule_detections__detection__events__security_result__about__user__department ;;
  }
}

view: rule_detections__detection__events__target__cloud__vpc__attribute__labels {
...
view: rule_detections__detection__events__principal__group__attribute__labels {
...
view: rule_detections__detection__events__observer__resource__attribute__labels {
...
view: rule_detections__detection__events__src__cloud__project__attribute__labels {
...
view: rule_detections__detection__events__about__user_management_chain__department {

  dimension: rule_detections__detection__events__about__user_management_chain__department {
    type: string
    sql: rule_detections__detection__events__about__user_management_chain__department ;;
  }
}

view: rule_detections__detection__events__intermediary__user__attribute__labels {
...
view: rule_detections__detection__events__security_result__about__asset__labels {
...
view: rule_detections__detection__events__principal__resource__attribute__labels {
...
view: rule_detections__detection__events__observer__cloud__vpc__attribute__labels {
...
view: rule_detections__detection__events__src__user_management_chain__phone_numbers {

  dimension: rule_detections__detection__events__src__user_management_chain__phone_numbers {
    type: string
    sql: rule_detections__detection__events__src__user_management_chain__phone_numbers ;;
  }
}

view: rule_detections__detection__events__intermediary__asset__attribute__labels {
...
view: rule_detections__detection__events__target__user_management_chain__department {

  dimension: rule_detections__detection__events__target__user_management_chain__department {
    type: string
    sql: rule_detections__detection__events__target__user_management_chain__department ;;
  }
}

view: rule_detections__detection__events__principal__cloud__vpc__attribute__labels {
...
view: rule_detections__detection__events__about__cloud__project__attribute__labels {
...
view: rule_detections__detection__events__intermediary__user_management_chain {
...
view: rule_detections__detection__events__security_result__about__asset__hardware {
...
view: rule_detections__detection__events__security_result__about__user__phone_numbers {

  dimension: rule_detections__detection__events__security_result__about__user__phone_numbers {
    type: string
    sql: rule_detections__detection__events__security_result__about__user__phone_numbers ;;
  }
}

view: rule_detections__detection__events__observer__user_management_chain__department {

  dimension: rule_detections__detection__events__observer__user_management_chain__department {
    type: string
    sql: rule_detections__detection__events__observer__user_management_chain__department ;;
  }
}

view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__ip {

  dimension: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__ip {
    type: string
    sql: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__ip ;;
  }
}

view: rule_detections__detection__events__src__user_management_chain__email_addresses {

  dimension: rule_detections__detection__events__src__user_management_chain__email_addresses {
    type: string
    sql: rule_detections__detection__events__src__user_management_chain__email_addresses ;;
  }
}

view: rule_detections__detection__events__about__user_management_chain__phone_numbers {

  dimension: rule_detections__detection__events__about__user_management_chain__phone_numbers {
    type: string
    sql: rule_detections__detection__events__about__user_management_chain__phone_numbers ;;
  }
}

view: rule_detections__detection__events__intermediary__group__attribute__labels {
...
view: rule_detections__detection__events__security_result__about__asset__software {
...
view: rule_detections__detection__events__target__cloud__project__attribute__labels {
...
view: rule_detections__detection__events__principal__user_management_chain__department {

  dimension: rule_detections__detection__events__principal__user_management_chain__department {
    type: string
    sql: rule_detections__detection__events__principal__user_management_chain__department ;;
  }
}

view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__mac {

  dimension: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__mac {
    type: string
    sql: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__mac ;;
  }
}

view: rule_detections__detection__events__intermediary__resource__attribute__labels {
...
view: rule_detections__detection__events__security_result__about__user__email_addresses {

  dimension: rule_detections__detection__events__security_result__about__user__email_addresses {
    type: string
    sql: rule_detections__detection__events__security_result__about__user__email_addresses ;;
  }
}

view: rule_detections__detection__events__target__user_management_chain__phone_numbers {

  dimension: rule_detections__detection__events__target__user_management_chain__phone_numbers {
    type: string
    sql: rule_detections__detection__events__target__user_management_chain__phone_numbers ;;
  }
}

view: rule_detections__detection__events__observer__cloud__project__attribute__labels {
...
view: rule_detections__detection__events__src__user_management_chain__group_identifiers {

  dimension: rule_detections__detection__events__src__user_management_chain__group_identifiers {
    type: string
    sql: rule_detections__detection__events__src__user_management_chain__group_identifiers ;;
  }
}

view: rule_detections__detection__events__about__user_management_chain__email_addresses {

  dimension: rule_detections__detection__events__about__user_management_chain__email_addresses {
    type: string
    sql: rule_detections__detection__events__about__user_management_chain__email_addresses ;;
  }
}

view: rule_detections__detection__events__intermediary__cloud__vpc__attribute__labels {
...
view: rule_detections__detection__events__security_result__about__process_ancestors {
...
view: rule_detections__detection__events__principal__cloud__project__attribute__labels {
...
view: rule_detections__detection__events__observer__user_management_chain__phone_numbers {

  dimension: rule_detections__detection__events__observer__user_management_chain__phone_numbers {
    type: string
    sql: rule_detections__detection__events__observer__user_management_chain__phone_numbers ;;
  }
}

view: rule_detections__detection__events__security_result__about__investigation__comments {

  dimension: rule_detections__detection__events__security_result__about__investigation__comments {
    type: string
    sql: rule_detections__detection__events__security_result__about__investigation__comments ;;
  }
}

view: rule_detections__detection__events__security_result__about__user__group_identifiers {

  dimension: rule_detections__detection__events__security_result__about__user__group_identifiers {
    type: string
    sql: rule_detections__detection__events__security_result__about__user__group_identifiers ;;
  }
}

view: rule_detections__detection__events__target__user_management_chain__email_addresses {

  dimension: rule_detections__detection__events__target__user_management_chain__email_addresses {
    type: string
    sql: rule_detections__detection__events__target__user_management_chain__email_addresses ;;
  }
}

view: rule_detections__detection__events__principal__user_management_chain__phone_numbers {

  dimension: rule_detections__detection__events__principal__user_management_chain__phone_numbers {
    type: string
    sql: rule_detections__detection__events__principal__user_management_chain__phone_numbers ;;
  }
}

view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__nat_ip {

  dimension: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__nat_ip {
    type: string
    sql: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__nat_ip ;;
  }
}

view: rule_detections__detection__events__about__user_management_chain__group_identifiers {

  dimension: rule_detections__detection__events__about__user_management_chain__group_identifiers {
    type: string
    sql: rule_detections__detection__events__about__user_management_chain__group_identifiers ;;
  }
}

view: rule_detections__detection__events__intermediary__user_management_chain__department {

  dimension: rule_detections__detection__events__intermediary__user_management_chain__department {
    type: string
    sql: rule_detections__detection__events__intermediary__user_management_chain__department ;;
  }
}

view: rule_detections__detection__events__security_result__about__group__email_addresses {

  dimension: rule_detections__detection__events__security_result__about__group__email_addresses {
    type: string
    sql: rule_detections__detection__events__security_result__about__group__email_addresses ;;
  }
}

view: rule_detections__detection__events__observer__user_management_chain__email_addresses {

  dimension: rule_detections__detection__events__observer__user_management_chain__email_addresses {
    type: string
    sql: rule_detections__detection__events__observer__user_management_chain__email_addresses ;;
  }
}

view: rule_detections__detection__events__src__user_management_chain__attribute__labels {
...
view: rule_detections__detection__events__target__user_management_chain__group_identifiers {

  dimension: rule_detections__detection__events__target__user_management_chain__group_identifiers {
    type: string
    sql: rule_detections__detection__events__target__user_management_chain__group_identifiers ;;
  }
}

view: rule_detections__detection__events__principal__user_management_chain__email_addresses {

  dimension: rule_detections__detection__events__principal__user_management_chain__email_addresses {
    type: string
    sql: rule_detections__detection__events__principal__user_management_chain__email_addresses ;;
  }
}

view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__asset__ip {

  dimension: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__asset__ip {
    type: string
    sql: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__asset__ip ;;
  }
}

view: rule_detections__detection__events__intermediary__cloud__project__attribute__labels {
...
view: rule_detections__detection__events__security_result__about__user__attribute__labels {
...
view: rule_detections__detection__events__observer__user_management_chain__group_identifiers {

  dimension: rule_detections__detection__events__observer__user_management_chain__group_identifiers {
    type: string
    sql: rule_detections__detection__events__observer__user_management_chain__group_identifiers ;;
  }
}

view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__asset__mac {

  dimension: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__asset__mac {
    type: string
    sql: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__asset__mac ;;
  }
}

view: rule_detections__detection__events__about__user_management_chain__attribute__labels {
...
view: rule_detections__detection__events__intermediary__user_management_chain__phone_numbers {

  dimension: rule_detections__detection__events__intermediary__user_management_chain__phone_numbers {
    type: string
    sql: rule_detections__detection__events__intermediary__user_management_chain__phone_numbers ;;
  }
}

view: rule_detections__detection__events__security_result__about__asset__attribute__labels {
...
view: rule_detections__detection__events__principal__user_management_chain__group_identifiers {

  dimension: rule_detections__detection__events__principal__user_management_chain__group_identifiers {
    type: string
    sql: rule_detections__detection__events__principal__user_management_chain__group_identifiers ;;
  }
}

view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__labels {
...
view: rule_detections__detection__events__security_result__about__user_management_chain {
...
view: rule_detections__detection__events__target__user_management_chain__attribute__labels {
...
view: rule_detections__detection__events__intermediary__user_management_chain__email_addresses {

  dimension: rule_detections__detection__events__intermediary__user_management_chain__email_addresses {
    type: string
    sql: rule_detections__detection__events__intermediary__user_management_chain__email_addresses ;;
  }
}

view: rule_detections__detection__events__security_result__about__group__attribute__labels {
...
view: rule_detections__detection__events__observer__user_management_chain__attribute__labels {
...
view: rule_detections__detection__events__security_result__about__resource__attribute__labels {
...
view: rule_detections__detection__events__principal__user_management_chain__attribute__labels {
...
view: rule_detections__detection__events__intermediary__user_management_chain__group_identifiers {

  dimension: rule_detections__detection__events__intermediary__user_management_chain__group_identifiers {
    type: string
    sql: rule_detections__detection__events__intermediary__user_management_chain__group_identifiers ;;
  }
}

view: rule_detections__detection__events__security_result__about__cloud__vpc__attribute__labels {
...
view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user__department {

  dimension: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user__department {
    type: string
    sql: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user__department ;;
  }
}

view: rule_detections__detection__events__security_result__about__user_management_chain__department {

  dimension: rule_detections__detection__events__security_result__about__user_management_chain__department {
    type: string
    sql: rule_detections__detection__events__security_result__about__user_management_chain__department ;;
  }
}

view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__asset__labels {
...
view: rule_detections__detection__events__intermediary__user_management_chain__attribute__labels {
...
view: rule_detections__detection__events__security_result__about__cloud__project__attribute__labels {
...
view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__asset__hardware {
...
view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user__phone_numbers {

  dimension: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user__phone_numbers {
    type: string
    sql: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user__phone_numbers ;;
  }
}

view: rule_detections__detection__events__security_result__about__user_management_chain__phone_numbers {

  dimension: rule_detections__detection__events__security_result__about__user_management_chain__phone_numbers {
    type: string
    sql: rule_detections__detection__events__security_result__about__user_management_chain__phone_numbers ;;
  }
}

view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__asset__software {
...
view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user__email_addresses {

  dimension: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user__email_addresses {
    type: string
    sql: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user__email_addresses ;;
  }
}

view: rule_detections__detection__events__security_result__about__user_management_chain__email_addresses {

  dimension: rule_detections__detection__events__security_result__about__user_management_chain__email_addresses {
    type: string
    sql: rule_detections__detection__events__security_result__about__user_management_chain__email_addresses ;;
  }
}

view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__process_ancestors {
...
view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__investigation__comments {

  dimension: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__investigation__comments {
    type: string
    sql: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__investigation__comments ;;
  }
}

view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user__group_identifiers {

  dimension: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user__group_identifiers {
    type: string
    sql: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user__group_identifiers ;;
  }
}

view: rule_detections__detection__events__security_result__about__user_management_chain__group_identifiers {

  dimension: rule_detections__detection__events__security_result__about__user_management_chain__group_identifiers {
    type: string
    sql: rule_detections__detection__events__security_result__about__user_management_chain__group_identifiers ;;
  }
}

view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__group__email_addresses {

  dimension: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__group__email_addresses {
    type: string
    sql: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__group__email_addresses ;;
  }
}

view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user__attribute__labels {
...
view: rule_detections__detection__events__security_result__about__user_management_chain__attribute__labels {
...
view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__asset__attribute__labels {
...
view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user_management_chain {
...
view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__group__attribute__labels {
...
view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__resource__attribute__labels {
...
view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__cloud__vpc__attribute__labels {
...
view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user_management_chain__department {

  dimension: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user_management_chain__department {
    type: string
    sql: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user_management_chain__department ;;
  }
}

view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__cloud__project__attribute__labels {
...
view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user_management_chain__phone_numbers {

  dimension: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user_management_chain__phone_numbers {
    type: string
    sql: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user_management_chain__phone_numbers ;;
  }
}

view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user_management_chain__email_addresses {

  dimension: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user_management_chain__email_addresses {
    type: string
    sql: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user_management_chain__email_addresses ;;
  }
}

view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user_management_chain__group_identifiers {

  dimension: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user_management_chain__group_identifiers {
    type: string
    sql: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user_management_chain__group_identifiers ;;
  }
}

view: rule_detections__detection__events__extensions__vulns__vulnerabilities__about__user_management_chain__attribute__labels {
